    ...
    <section className="w-full py-0">
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        <Card
          ...
          des="I am actively seeking experience in front-end development using modern technologies like React.js and striving to provide easy-to-use, interactive web applications."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="Becoming a Versatile Mobile Developer"
          icon={<AceternityIcon order="Phase 2" />}
          des="I'm learning React Native to build versatile mobile apps for iOS and Android platforms, focusing on quality, performance and user experience."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Learning how to create impactful applications"
          icon={<AceternityIcon order="Phase 3" />}
          des="My goal is to develop impactful applications that make a difference, from concept to launch, ensuring high standards of functionality, design and user satisfaction."
        >
          <CanvasRevealEffect
            animationSpeed={3}
